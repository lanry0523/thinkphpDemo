			...
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="/think-demo/Application/Admin/View/Public/homeList/img/user.png" class="img-circle" alt="Avatar"> <span>Samuel</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
							<ul class="dropdown-menu">
		...
		<div class="main">					
							...
							<div class="panel" style="width:50%">
								...
								<div class="panel-body" style="text-align:right">
									<form action="<?php echo U('Login/addUser');?>" method="post">																	
